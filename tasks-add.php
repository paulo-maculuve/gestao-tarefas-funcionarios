...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tarefas (descricao, inicio, prazo, prioridade, id_funcionario ) 
                  VALUES ('$descricao', '$inicioDataFormatada', '$entregaDataFormatada', '$prioridade', '$idFuncionario')";
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea id="" class="form-control" cols="30" rows="4" name="descricao"></textarea>
                                                    
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="nome" class="form-label">Data de Inicio</label>
                                                        <input type="date" class="form-control" id="nome" required name="dataInicio">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="depone" class="form-label">Data de Entrega</label>
                                                        <input type="date" class="form-control" id="depone" required name="dataEntrega">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="depone" class="form-label">Prioridade</label>
                                                        <select class="form-control" name="prioridade" required>
                                                            <option select disible>Selecione a prioridade</option>
